 ...
 * @author MSI Laptop
 */
public class viewPhieuDoi extends javax.swing.JFrame {
    ...
    private ArrayList<NhanVien> listcbbNhanVien = nhanVienRepository.getAllNhanVien();
    /**
    ...
    public void LoadPD() {
        ...
        for (PhieuDoi ms : this.phieuDoiRepository.getAllPD()) {
    ...
    private PhieuDoi getFormData() {
        ...
        try {
            ...
            models.NhanVien nhanVien = listcbbNhanVien.get(cboNV.getSelectedIndex());
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        this.phieuDoiRepository.add(pd);
        this.LoadPD();
        this.clear();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        phieuDoiRepository.update(id, pd);
        this.LoadPD();
        this.clear();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewPhieuDoi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewPhieuDoi().setVisible(true);
            }
        });
    }
