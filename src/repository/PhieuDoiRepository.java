...
public class PhieuDoiRepository implements PhieuDoiService {
    ...
    public ArrayList<PhieuDoi> getAllPD() {
        String sql = """
                     SELECT [IdPhieuDoi]
                       ...
                       join SanPhamChiTiet on SanPhamChiTiet.IdSanPhamChiTiet = PhieuDoi.IdChiTietSanPham""";
        ...
        try {
            ...
            while (rs.next() == true) {
                ...
                System.out.println(sp.getIdSanPhamChiTiet());
    ...
    public static void main(String[] args) {
        System.out.println(new PhieuDoiRepository().getAllPD().toString());
    }
}
